		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "student form",
									"targetURL": "#comcpgformformmodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcpgformformmodule-display": {
								"semanticObject": "comcpgformformmodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cpg.form.formmodule",
									"url": sap.ui.require.toUrl("com/cpg/form/formmodule")
								}
							}
						}
					}
