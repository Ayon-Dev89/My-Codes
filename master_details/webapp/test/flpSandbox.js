		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comcpgmastermasterdetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcpgmastermasterdetails-display": {
								"semanticObject": "comcpgmastermasterdetails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cpg.master.masterdetails",
									"url": sap.ui.require.toUrl("com/cpg/master/masterdetails")
								}
							}
						}
					}
